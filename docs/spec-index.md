...
| SPEC-AI-ASSISTANT-001 | [spec-ai-assistant.md](spec-ai-assistant.md) | Implemented (v1) | REQ-AI-ASSISTANT-001 | platform, i18n, api-automation | Admin-only RAG chatbot (streaming SSE, EN/ES, PII anonymization, conversation history); backend proxy to stateless aiagent; v2 agent actions deferred |
